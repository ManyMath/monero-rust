...
//! Integration-style tests for WalletActor
//! These tests verify actor behavior through message passing rather than
...
/// Test helper to create a WalletActor for testing
fn create_test_wallet_actor() -> (Address<WalletActor>, Context<WalletActor>) {
    let ctx = Context::new();
