...
pub(crate) fn route_dart_signal(signal_id: u32, data: Vec<u8>) {
    ...
    let result: Result<(), String> = match signal_id {
        MONERO_TEST_REQUEST =>
            crate::ffi_web::send_monero_test_request(json_str),
        CREATE_WALLET_REQUEST =>
            crate::ffi_web::send_create_wallet_request(json_str),
        START_SYNC_REQUEST =>
            crate::ffi_web::send_start_sync_request(json_str),
        GET_BALANCE_REQUEST =>
            crate::ffi_web::send_get_balance_request(json_str),
        CREATE_TRANSACTION_REQUEST =>
            crate::ffi_web::send_create_transaction_request(json_str),
        SWEEP_ALL_REQUEST =>
            crate::ffi_web::send_sweep_all_request(json_str),
        GENERATE_SEED_REQUEST =>
            crate::ffi_web::send_generate_seed_request(json_str),
        GET_SEED_BIRTHDAY_REQUEST =>
            crate::ffi_web::send_get_seed_birthday_request(json_str),
        ...
        DERIVE_ADDRESS_REQUEST =>
            crate::ffi_web::send_derive_address_request(json_str),
        DERIVE_SUBADDRESS_REQUEST =>
            crate::ffi_web::send_derive_subaddress_request(json_str),
        DERIVE_KEYS_REQUEST =>
            crate::ffi_web::send_derive_keys_request(json_str),
        SCAN_BLOCK_REQUEST =>
            crate::ffi_web::send_scan_block_request(json_str),
        BROADCAST_TRANSACTION_REQUEST =>
            crate::ffi_web::send_broadcast_transaction_request(json_str),
        QUERY_DAEMON_HEIGHT_REQUEST =>
            crate::ffi_web::send_query_daemon_height_request(json_str),
        START_CONTINUOUS_SCAN_REQUEST =>
            crate::ffi_web::send_start_continuous_scan_request(json_str),
        STOP_SCAN_REQUEST =>
            crate::ffi_web::send_stop_scan_request(json_str),
        MEMPOOL_SCAN_REQUEST =>
            crate::ffi_web::send_mempool_scan_request(json_str),
        GENERATE_OUT_PROOF_REQUEST =>
            crate::ffi_web::send_generate_out_proof_request(json_str),
        SAVE_WALLET_DATA_REQUEST =>
            crate::ffi_web::send_save_wallet_data_request(json_str),
        LOAD_WALLET_DATA_REQUEST =>
            crate::ffi_web::send_load_wallet_data_request(json_str),
        ...
        RESTORE_WALLET_DATA_REQUEST =>
            crate::ffi_web::send_restore_wallet_data_request(json_str),
        GET_BLOCK_HASHES_REQUEST =>
            crate::ffi_web::send_get_block_hashes_request(json_str),
        GET_PENDING_STATE_REQUEST =>
            crate::ffi_web::send_get_pending_state_request(json_str),
        CONVERT_BIP39_TO_LEGACY_REQUEST =>
            crate::ffi_web::send_convert_bip39_to_legacy_request(json_str),
        FREEZE_OUTPUT_REQUEST =>
            crate::ffi_web::send_freeze_output_request(json_str),
        THAW_OUTPUT_REQUEST =>
            crate::ffi_web::send_thaw_output_request(json_str),
