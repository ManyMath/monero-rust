...
/// Build script for browser extension (flutter_rust_bridge)
void main() async {
  print('\nBuilding extension...');
...
class ExtensionBuilder {
  ...
  Future<void> _checkPrerequisites() async {
    ...
    final frbResult = await _runCommand('flutter_rust_bridge_codegen', ['--version'], silent: true);
    if (!frbResult) {
      throw Exception('flutter_rust_bridge_codegen is not installed. Install with: cargo install flutter_rust_bridge_codegen');
    }
  ...
  Future<void> _generateBindings() async {
    print('\nGenerating bindings...');
    final success = await _runCommand('flutter_rust_bridge_codegen', ['generate'], workingDir: projectRoot);
    if (!success) {
  ...
  Future<void> _buildFlutterWeb() async {
    print('\nBuilding Flutter web (includes WASM)...');
