...
impl ChainConfig {
    ...
    pub fn monero_stagenet(rpc_url: String) -> Self {
        ChainConfig {
            ...
            genesis_hash: [
                0x76, 0xee, 0x3c, 0xc9, 0x86, 0x46, 0x29, 0x22,
                0x06, 0xcd, 0x3e, 0x86, 0xf7, 0x4d, 0x88, 0xb4,
                0xdc, 0xc1, 0xd9, 0x37, 0x08, 0x86, 0x45, 0xe9,
                0xb0, 0xcb, 0xca, 0x84, 0xb7, 0xce, 0x74, 0xeb,
            ],
    ...
    pub fn child_stagenet(rpc_url: String) -> Self {
        ChainConfig {
            ...
            network: Network::Stagenet,
            genesis_hash: [
                0x57, 0x30, 0xFF, 0x0A, 0x9D, 0x8F, 0x61, 0x96,
                0x91, 0xF2, 0xC2, 0xA1, 0xF2, 0xEB, 0xA1, 0x08,
                0x3C, 0xC8, 0x95, 0xFE, 0x95, 0x1F, 0xD8, 0x87,
                0x20, 0x10, 0x28, 0x51, 0x0E, 0x1D, 0x66, 0xD7,
            ],
